    ...
    Column(modifier = Modifier
        ...
        Card(modifier = Modifier.align(Alignment.CenterHorizontally).height(300.dp), colors = CardDefaults.cardColors(containerColor = Color.Transparent)){
            Column(modifier = Modifier.fillMaxHeight(), verticalArrangement = Arrangement.SpaceBetween){
                ...
                Text(text = "Enviaremos um e-mail com instruções de como redefinir sua senha", fontSize = 12.sp, color = Color(0xff5DA5B7), fontWeight = FontWeight.Medium, modifier = Modifier.width(205.dp).height(28.dp), textAlign = TextAlign.Center)
                OutlinedTextField(onValueChange = {}, value = " ", colors = OutlinedTextFieldDefaults.colors(unfocusedContainerColor = Color(0xffB8CED4), focusedBorderColor = Color.Transparent, unfocusedBorderColor = Color.Transparent, focusedContainerColor = Color(0xffB8CED4)), modifier = Modifier
                    .height(40.dp)
                    .width(260.dp), label = { Text(text = "E-mail") })
